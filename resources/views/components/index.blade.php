<div>
    ...
    <tbody>
        @foreach ($variabls as $employe)
            <tr>
                <th scope="row">{{$employe->id}} </th>
                <td>{{$employe->fullname}}</td>
                <td>@if ($employe->departement)
            ...
            <button class="btn btn-primary me-2"><a class="nav-link" href="{{route('employe.show' , $employe->id)}}">
            ...
            <button class="btn btn-warning me-2"><a class="nav-link" href="{{route('employe.edit' , $employe->id)}}">
